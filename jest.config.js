module.exports = {
  projects: [
    ...
    '<rootDir>/libs/api/nest/shared/users/core/application-services',
    '<rootDir>/libs/api/nest/shared/users/core/domain-services',
    '<rootDir>/libs/api/nest/shared/users/core/domain',
    '<rootDir>/libs/api/nest/shared/users/infrastructure',
    '<rootDir>/libs/api/nest/shared/users/shell',
    '<rootDir>/libs/api/nest/shared/users/ui-rest',
